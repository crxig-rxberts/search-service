...
const { NotFoundError, ValidationError, UnauthorizedError, BadGatewayError } = require('../../../src/middleware/errors');
...
describe('errorHandler', () => {
  ...
  it('should handle BadGatewayError', () => {
    ...
    expect(formatResponse).toHaveBeenCalledWith('Bad gateway', null, false);
    expect(mockRes.json).toHaveBeenCalledWith({
      message: 'Bad gateway',
      data: null,
      success: false
  ...
  it('should handle unknown errors', () => {
    ...
    expect(logger.error).toHaveBeenCalledWith('Error caught by middleware', expect.objectContaining({ error }));
